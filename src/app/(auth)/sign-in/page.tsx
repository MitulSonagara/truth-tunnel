                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                            <Input className="rounded-xl dark:border-gray-300
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <div className="relative">
                                            ...
                                            <FormControl>
                                                <Input className="rounded-xl dark:border-gray-300 " type={hidden ? "password" : "text"} placeholder="Enter Password" {...field} />
                                            </FormControl>
                                        </div>
                                        <FormMessage />
                                    </FormItem>
                            ...
                            />
                            <Button type="submit" className="rounded-xl bg-gray-700 w-full hover:bg-gray-900 dark:hover:bg-gray-500 hover:shadow-xl" disabled={loading}>
